export const cashAccounts = [
  ...
  { id: 'kas-brankas-bahan-baku', name: 'Brankas Bahan Baku', type: 'cash', balance: 0, status: 'active' },
  { id: 'kas-brankas-operasional', name: 'Brankas Operasional', type: 'cash', balance: 0, status: 'active' },
  { id: 'kas-brankas-keuntungan', name: 'Brankas Keuntungan', type: 'cash', balance: 0, status: 'active' },
